...
aws ssm put-parameter --name '/st-marche/dev/api/ecommerce-prices/api-domain' --value $developmentDomain --overwrite --type String
# set api-domain for staging
aws ssm put-parameter --name '/st-marche/staging/api/ecommerce-prices/api-domain' --value $stagingDomain --overwrite --type String
# set api-domain for production
aws ssm put-parameter --name '/st-marche/production/api/ecommerce-prices/api-domain' --value $productionDomain --overwrite --type String
